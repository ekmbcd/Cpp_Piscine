...
{
	std::cout << _name << " shoots his ninja gun at " << target << " causing " << _ranged_dmg << " points of damage!" << std::endl;
}

void	NinjaTrap::meleeAttack(std::string const & target)
{
	std::cout << _name << " hits " << target << " with his katana, causing " << _melee_dmg << " points of damage. It's super effective!" << std::endl;
}
